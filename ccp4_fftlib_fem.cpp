  ...
  bool& error)
{
  ...
  int pp_memory[14];
  int qq_memory[7];
  arr_ref<int> pp(pp_memory[0]);
  arr_ref<int> qq(qq_memory[0]);
  pp(dimension(14));
  qq(dimension(7));
  int r = fem::int0;
  int jj = fem::int0;
  ...
  arr_cref<int> dim)
{
  ...
  float a_memory[18];
  float b_memory[18];
  arr_ref<float> a(a_memory[0]);
  arr_ref<float> b(b_memory[0]);
  a(dimension(18));
  b(dimension(18));
  int v = fem::int0;
  float aa_memory[9*9];
  float bb_memory[9*9];
  arr_ref<float, 2> aa(aa_memory[0]);
  arr_ref<float, 2> bb(bb_memory[0]);
  aa(dimension(9, 9));
  bb(dimension(9, 9));
  int j = fem::int0;
  bool fold = fem::bool0;
  ...
  float c_memory[18];
  float s_memory[18];
  arr_ref<float> c(c_memory[0]);
  arr_ref<float> s(s_memory[0]);
  c(dimension(18));
  s(dimension(18));
  int kk = fem::int0;
  int l = fem::int0;
  ...
  float rb_memory[9];
  float ib_memory[9];
  arr_ref<float> ra(ra_memory[0]);
  arr_ref<float> ia(ia_memory[0]);
  arr_ref<float> rb(rb_memory[0]);
  arr_ref<float> ib(ib_memory[0]);
  ra(dimension(9));
  ia(dimension(9));
  rb(dimension(9));
  ib(dimension(9));
  ...
  arr_ref<float> y)
{
  ...
  int u_memory[14];
  int s_memory[14];
  arr_ref<int> u(u_memory[0]);
  arr_ref<int> s(s_memory[0]);
  u(dimension(14));
  s(dimension(14));
  int& al = u(1);
  int& bl = u(2);
  ...
  int modulo_memory[14];
  arr_ref<int> modulo(modulo_memory[0]);
  modulo(dimension(14));
  int kk = fem::int0;
  nest = 14;
  nt = dim(1);
  ...
  arr_cref<int> d)
{
  ...
  int pmax = 19;
  int twogrp = 8;
  int factor_memory[15];
  int sym_memory[15];
  int unsym_memory[15];
  arr_ref<int> factor(factor_memory[0]);
  arr_ref<int> sym(sym_memory[0]);
  arr_ref<int> unsym(unsym_memory[0]);
  factor(dimension(15));
  sym(dimension(15));
  unsym(dimension(15));
  int psym = fem::int0;
